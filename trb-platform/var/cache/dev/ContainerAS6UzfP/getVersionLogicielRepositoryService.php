...
// Returns the private 'App\Repository\VersionLogicielRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\VersionLogicielRepository.php';

return $this->privates['App\\Repository\\VersionLogicielRepository'] = new \App\Repository\VersionLogicielRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
