...
// Returns the private 'App\Repository\AssociationEquiptERTMSRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AssociationEquiptERTMSRepository.php';

return $this->privates['App\\Repository\\AssociationEquiptERTMSRepository'] = new \App\Repository\AssociationEquiptERTMSRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
