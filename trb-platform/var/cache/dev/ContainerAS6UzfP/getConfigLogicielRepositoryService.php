...
// Returns the private 'App\Repository\ConfigLogicielRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ConfigLogicielRepository.php';

return $this->privates['App\\Repository\\ConfigLogicielRepository'] = new \App\Repository\ConfigLogicielRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
