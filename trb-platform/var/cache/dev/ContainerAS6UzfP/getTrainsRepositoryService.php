...
// Returns the private 'App\Repository\TrainsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TrainsRepository.php';

return $this->privates['App\\Repository\\TrainsRepository'] = new \App\Repository\TrainsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
