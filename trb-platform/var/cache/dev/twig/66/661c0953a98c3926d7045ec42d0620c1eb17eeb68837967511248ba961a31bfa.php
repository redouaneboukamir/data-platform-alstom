...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        <div class=\"d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom\">
            <h1>Add Baseline - Realase note - Config Logiciel</h1>
        </div>

        ";
        // line 14
        echo "        <div class=\"jumbotron content-form-baseline\">
            <h3 id=\"title_baseline\">Baseline</h3>
            ";
        // line 16
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 16, $this->source); })()), 'form_start', ["action" => $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("alstom.addBaseline"), "attr" => ["id" => "form_baseline"]]);
        // line 17
        echo "
        ...
        // line 20
        echo twig_escape_filter($this->env, (((isset($context["button"]) || array_key_exists("button", $context))) ? (_twig_default_filter((isset($context["button"]) || array_key_exists("button", $context) ? $context["button"] : (function () { throw new RuntimeError('Variable "button" does not exist.', 20, $this->source); })()), "Send")) : ("Send")), "html", null, true);
        echo "</button>
            ";
        // line 21
        ...
        // line 25
        echo "        <div class=\"jumbotron content-form-baseline\">
            <h3 id=\"title_version\">Version Logiciel</h3>
            ";
        // line 27
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form_version"]) || array_key_exists("form_version", $context) ? $context["form_version"] : (function () { throw new RuntimeError('Variable "form_version" does not exist.', 27, $this->source); })()), 'form_start', ["action" => $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("alstom.addVersion"), "attr" => ["id" => "form_version"]]);
        // line 28
        echo "
            ";
        // line 29
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form_version"]) || array_key_exists("form_version", $context) ? $context["form_version"] : (function () { throw new RuntimeError('Variable "form_version" does not exist.', 29, $this->source); })()), "release_note", [], "any", false, false, false, 29), 'row');
        echo "
            <button class=\"btn btn-primary mt-4\">";
        // line 30
        ...
        echo "</button>
            ";
        // line 31
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form_version"]) || array_key_exists("form_version", $context) ? $context["form_version"] : (function () { throw new RuntimeError('Variable "form_version" does not exist.', 31, $this->source); })()), 'form_end');
        echo "
        </div>
...
";
    ...
    {
        return array (  165 => 38,  155 => 37,  139 => 31,  135 => 30,  131 => 29,  128 => 28,  126 => 27,  122 => 25,  116 => 21,  112 => 20,  108 => 19,  104 => 17,  102 => 16,  98 => 14,  91 => 8,  81 => 7,  70 => 2,  60 => 1,  37 => 6,);
    }
...
{% block body %}
    <main class=\"col-md-9 ml-sm-auto col-lg-10 px-4\" role=\"main\">
        ...
        <div class=\"jumbotron content-form-baseline\">
            <h3 id=\"title_baseline\">Baseline</h3>
            {{ form_start(form, {'action': path('alstom.addBaseline'), 
        ...
        {# Formulaire d'ajout de version logiciel #}
        <div class=\"jumbotron content-form-baseline\">
            <h3 id=\"title_version\">Version Logiciel</h3>
