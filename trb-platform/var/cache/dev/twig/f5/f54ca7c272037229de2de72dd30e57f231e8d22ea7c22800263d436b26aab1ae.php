...
class __TwigTemplate_a5790e20fab79ad4c3a3e86eddaa051c54ecb1a24dc6a90d59ac92682256cc8d extends \Twig\Template
{
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        echo "\" class=\"btn-primary btn col-12\">Add baseline</a>
                        <p class=\"btn-success btn col-12 mt-2\">Update baseline</p>
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["train"]) || array_key_exists("train", $context) ? $context["train"] : (function () { throw new RuntimeError('Variable "train" does not exist.', 76, $this->source); })()), "baselines", [], "any", false, false, false, 76));
        foreach ($context['_seq'] as $context["_key"] => $context["baseline"]) {
            ...
            if (twig_get_attribute($this->env, $this->source, $context["baseline"], "status", [], "any", false, false, false, 77)) {
                ...
                echo "                                            <td class=\"td-table\">
                                                <a href=\"";
                // line 79
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("alstom.show-baseline", ["id" => twig_get_attribute($this->env, $this->source, $context["baseline"], "id", [], "any", false, false, false, 79)]), "html", null, true);
                echo "\">
                                                    ";
                // line 80
    ...
    {
        return array (  201 => 86,  194 => 84,  187 => 80,  183 => 79,  180 => 78,  177 => 77,  173 => 76,  159 => 65,  151 => 59,  145 => 56,  140 => 55,  138 => 54,  107 => 25,  101 => 22,  98 => 21,  92 => 18,  89 => 17,  87 => 16,  77 => 9,  71 => 6,  68 => 5,  58 => 4,  35 => 1,);
    }
