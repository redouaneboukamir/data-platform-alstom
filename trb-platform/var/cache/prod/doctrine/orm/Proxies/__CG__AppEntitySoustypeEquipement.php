 ...
 */
class SoustypeEquipement extends \App\Entity\SoustypeEquipement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SoustypeEquipement $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setName(string $name): \App\Entity\SoustypeEquipement
    {
