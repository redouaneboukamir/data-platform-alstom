...
// Returns the private 'App\Repository\EVCRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\EVCRepository.php';

return $this->privates['App\\Repository\\EVCRepository'] = new \App\Repository\EVCRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
