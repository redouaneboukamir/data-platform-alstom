...
// Returns the private 'App\Repository\AssociationEVCConfigRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AssociationEVCConfigRepository.php';

return $this->privates['App\\Repository\\AssociationEVCConfigRepository'] = new \App\Repository\AssociationEVCConfigRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
