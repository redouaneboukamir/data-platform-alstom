...
// Returns the private 'App\Repository\EngineersRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\EngineersRepository.php';

return $this->privates['App\\Repository\\EngineersRepository'] = new \App\Repository\EngineersRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
