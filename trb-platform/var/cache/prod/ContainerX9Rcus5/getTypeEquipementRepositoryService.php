...
// Returns the private 'App\Repository\TypeEquipementRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TypeEquipementRepository.php';

return $this->privates['App\\Repository\\TypeEquipementRepository'] = new \App\Repository\TypeEquipementRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
