...
// Returns the private 'App\Repository\ERTMSEquipementRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ERTMSEquipementRepository.php';

return $this->privates['App\\Repository\\ERTMSEquipementRepository'] = new \App\Repository\ERTMSEquipementRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
