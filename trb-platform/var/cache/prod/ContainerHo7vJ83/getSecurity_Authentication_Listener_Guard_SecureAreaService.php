...
// Returns the private 'security.authentication.listener.guard.secure_area' shared service.
...
return $this->privates['security.authentication.listener.guard.secure_area'] = new \Symfony\Component\Security\Guard\Firewall\GuardAuthenticationListener($a, ($this->privates['security.authentication.manager'] ?? $this->getSecurity_Authentication_ManagerService()), 'secure_area', new RewindableGenerator(function () {
