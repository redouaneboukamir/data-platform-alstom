...
// Returns the private 'App\Repository\SoustypeEquipementRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\SoustypeEquipementRepository.php';

return $this->privates['App\\Repository\\SoustypeEquipementRepository'] = new \App\Repository\SoustypeEquipementRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
