...
// Returns the private 'App\Repository\TrainsSearchRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TrainsSearchRepository.php';

return $this->privates['App\\Repository\\TrainsSearchRepository'] = new \App\Repository\TrainsSearchRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
