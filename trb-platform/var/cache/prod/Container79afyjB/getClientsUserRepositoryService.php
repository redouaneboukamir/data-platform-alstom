...
// Returns the private 'App\Repository\ClientsUserRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ClientsUserRepository.php';

return $this->privates['App\\Repository\\ClientsUserRepository'] = new \App\Repository\ClientsUserRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
