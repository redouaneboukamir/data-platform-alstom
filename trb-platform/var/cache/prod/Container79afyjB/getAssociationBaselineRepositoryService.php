...
// Returns the private 'App\Repository\AssociationBaselineRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AssociationBaselineRepository.php';

return $this->privates['App\\Repository\\AssociationBaselineRepository'] = new \App\Repository\AssociationBaselineRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
