...
// Returns the private 'App\Repository\BaselineRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\BaselineRepository.php';

return $this->privates['App\\Repository\\BaselineRepository'] = new \App\Repository\BaselineRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
