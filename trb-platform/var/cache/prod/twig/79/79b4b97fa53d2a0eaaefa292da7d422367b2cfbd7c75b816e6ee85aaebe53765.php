...
class __TwigTemplate_2fee224a52ce0948d791be1902b872db23a76723f303eeb416afd7152f24829c extends \Twig\Template
{
    private $source;
...
($context["id"] ?? null)]);
    ...
    public function block_form_rows($context, array $blocks = [])
    {
        // line 402
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_array_filter(($context["form"] ?? null), function ($__child__) use ($context) { $context["child"] = $__child__; return  !twig_get_attribute($this->env, $this->source, $context["child"], "rendered", [], "any", false, false, false, 402); }));
        foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
            // line 403
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($context["child"], 'row');
        }
