...
function () {
  ...
  _createClass(Client, [{
    ...
    value: function setRequestOptions(options) {
      ...
      this.reqOptions = _lodash.default.pick(options, ['agent', 'ca', 'cert', 'ciphers', 'clientCertEngine', 'crl', 'dhparam', 'ecdhCurve', 'honorCipherOrder', 'key', 'passphrase', 'pfx', 'rejectUnauthorized', 'secureOptions', 'secureProtocol', 'servername', 'sessionIdContext']);
    ...
    value: function fPutObject(bucketName, objectName, filePath, metaData, callback) {
      ...
      (0, _helpers.insertContentType)(metaData, filePath); //Updates metaData to have the correct prefix if needed
      ...
      _async.default.waterfall([function (cb) {
        ...
        _async.default.whilst(function () {
          ...
          var options = {
            autoClose,
            start,
            end // verify md5sum of each part
