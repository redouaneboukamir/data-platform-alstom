...
/**
 * @ORM\Entity(repositoryClass="App\Repository\FleetsRepository")
 * @UniqueEntity("name")
 * @Vich\Uploadable()
 */
class Fleets
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Clients", mappedBy="Fleets")
     */
    private $clients;

    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Engineers", mappedBy="Fleets")
     */
    private $engineers;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Trains", mappedBy="Fleets")
     */
    private $trains;
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\ClientsUser", mappedBy="Fleets")
     */
    private $clientsUsers;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Projects", inversedBy="Fleets")
     */
    private $projects;
     ...
     * @throws \Exception
     */
    public function setProfilePicture(?File $profile_picture): Fleets
    {
